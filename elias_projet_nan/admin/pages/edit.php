...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="nom" name="nom" aria-describedby="emailHelp" placeholder="Entrer nom" value="<?= $maison->nom ?>"
  ...
  <div class="form-group">
      ...
      <textarea class="form-control" id="exampleTextarea" name="description" rows="3"><?= $maison->description ?></textarea>
